...
{{-- AD SLOT --}}
<div style="border:1px solid #e0e0e0;background:#fafafa;border-radius:4px;padding:16px;text-align:center;color:#bbb;font-size:11px;text-transform:uppercase;margin-bottom:16px">
    @include('components.ad-slot', ['position' => 'sidebar_top'])
</div>

{{-- TRENDING --}}
<div class="widget">
    <div class="widget-head red"><i class="fa-solid fa-fire"></i> Trending Now</div>
...
{{-- NEWSLETTER --}}
<div class="widget">
    <div class="widget-head"><i class="fa-regular fa-envelope"></i> Daily Newsletter</div>
    <div class="widget-body" style="background:#fffbf0">
        ...
        <div id="nlMsg" style="display:none;color:#27ae60;font-weight:600;margin-top:8px;padding:8px;background:#d4edda;border-radius:3px;font-size:13px"><i class="fa-solid fa-circle-check"></i> Subscribed! Thank you.</div>
    </div>
</div>

{{-- WEATHER --}}
<div class="widget">
    <div class="widget-head"><i class="fa-solid fa-cloud-sun"></i> Live Weather</div>
    <div class="widget-body">
        <div class="weather-grid">
            ...
            <div class="weather-city" data-city="{{ $city }}">
                ...
                <div class="weather-icon"><i class="fa-solid fa-cloud-sun" style="font-size:20px;color:#6e6e73"></i></div>
...
{{-- GOLD --}}
<div class="widget">
    <div class="widget-head" style="background:#b8860b"><i class="fa-solid fa-medal"></i> Live Gold & Silver (AUD)</div>
    <div class="widget-body">
        <div class="metal-section">
            <div class="metal-label gold-label"><i class="fa-solid fa-circle" style="color:#d4ac0d"></i> Gold (24K)</div>
        ...
        <div class="metal-section" style="margin-top:10px">
            <div class="metal-label silver-label"><i class="fa-solid fa-circle" style="color:#708090"></i> Silver</div>
            <div class="metal-grid">
...
{{-- CURRENCY --}}
<div class="widget">
    <div class="widget-head blue"><i class="fa-solid fa-arrow-right-arrow-left"></i> NPR ↔ AUD</div>
    <div class="widget-body">
        ...
        <button onclick="switchCurrency()" class="widget-btn-outline"><i class="fa-solid fa-arrows-up-down"></i> Switch Direction</button>
...
{{-- RASHIFAL --}}
<div style="background:#0d0221;border-radius:4px;overflow:hidden;margin-bottom:14px;box-shadow:0 4px 16px rgba(74,35,90,0.4)">

    {{-- Header --}}
    <div style="background:#4a235a;padding:10px 14px;display:flex;align-items:center;justify-content:space-between">
        <div style="display:flex;align-items:center;gap:8px">
            <i class="fa-solid fa-moon" style="color:#c39bd3;font-size:16px"></i>
            <div>
                <div style="color:white;font-size:12px;font-weight:700;text-transform:uppercase">Rashifal</div>
                <div style="color:rgba(255,255,255,0.6);font-size:10px">Daily Horoscope</div>
            </div>
        </div>
        <div style="text-align:right">
            <div style="color:rgba(255,255,255,0.5);font-size:10px">{{ now()->format('d M Y') }}</div>
            <div style="color:#f1c40f;font-size:10px;margin-top:1px"><i class="fa-solid fa-star" style="font-size:8px"></i> Updated Daily</div>
        </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:3px;padding:10px 10px 0">
        ...
        <button
            ...
            data-to="{{ $to }}"
            id="zpill-{{ $sign }}"
            style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:4px;padding:7px 3px;text-align:center;cursor:pointer;transition:all .2s;font-family:inherit"
        ...
        >
            ...
            <div style="font-size:8px;color:rgba(255,255,255,0.5);margin-top:2px;text-transform:uppercase">{{ substr(ucfirst($sign),0,3) }}</div>
        </button>
        @endforeach
    </div>
    ...
    <div style="padding:14px 14px 16px">
        ...
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;padding-bottom:12px;border-bottom:1px solid rgba(255,255,255,0.08)">
            <div id="rashiEmoji" style="font-size:44px;line-height:1;transition:all .3s">♈</div>
            <div style="flex:1">
                ...
                <div id="rashiStars" style="color:#f1c40f;font-size:13px;margin-top:4px">★★★★☆</div>
            </div>
            <div style="text-align:center">
                <div id="rashiElement" style="font-size:20px"><i class="fa-solid fa-fire" style="color:#e74c3c"></i></div>
                <div id="rashiElementName" style="color:rgba(255,255,255,0.4);font-size:9px;margin-top:2px">Fire</div>
            </div>
        </div>

        {{-- Horoscope Text --}}
        <div id="horoscopeText" style="background:rgba(255,255,255,0.04);border-left:3px solid #7d3c98;border-radius:0 4px 4px 0;padding:12px 14px;color:rgba(255,255,255,0.82);font-size:13px;line-height:1.8;font-style:italic;min-height:80px;transition:all .3s">
            <span style="color:rgba(255,255,255,0.35);font-size:12px">Loading your cosmic reading...</span>
        </div>

        {{-- Lucky Info --}}
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:6px;margin-top:10px">
            <div style="background:rgba(255,255,255,0.05);border-radius:4px;padding:7px;text-align:center;border:1px solid rgba(255,255,255,0.07)">
                <div style="font-size:13px"><i class="fa-solid fa-hashtag" style="color:#a569bd"></i></div>
                <div style="color:rgba(255,255,255,0.4);font-size:9px;text-transform:uppercase;margin-top:2px">Lucky No.</div>
                <div id="rashiNum" style="color:#a569bd;font-weight:700;font-size:14px;margin-top:1px">7</div>
            </div>
            <div style="background:rgba(255,255,255,0.05);border-radius:4px;padding:7px;text-align:center;border:1px solid rgba(255,255,255,0.07)">
                <div style="font-size:13px"><i class="fa-solid fa-palette" style="color:#a569bd"></i></div>
                <div style="color:rgba(255,255,255,0.4);font-size:9px;text-transform:uppercase;margin-top:2px">Color</div>
                <div id="rashiColor" style="color:#a569bd;font-weight:700;font-size:11px;margin-top:1px">Red</div>
            </div>
            <div style="background:rgba(255,255,255,0.05);border-radius:4px;padding:7px;text-align:center;border:1px solid rgba(255,255,255,0.07)">
                <div style="font-size:13px"><i class="fa-solid fa-gem" style="color:#a569bd"></i></div>
                <div style="color:rgba(255,255,255,0.4);font-size:9px;text-transform:uppercase;margin-top:2px">Stone</div>
...
<div class="nepali-date-widget">
    <div class="nepali-date-header">
        <span><i class="fa-regular fa-calendar"></i> Today's Date</span>
    ...
    <div class="nepali-date-body">
        <div class="nepali-date-grid">
            ...
            $bsMonthsNe = ['बैशाख','जेठ','असार','श्रावण','भाद्र','आश्विन','कार्तिक','मंसिर','पौष','माघ','फाल्गुन','चैत्र'];
            $bsMonthsEn = ['Baisakh','Jestha','Ashadh','Shrawan','Bhadra','Ashwin','Kartik','Mangsir','Poush','Magh','Falgun','Chaitra'];
        ...
        <div style="text-align:center;background:rgba(255,255,255,0.05);border-radius:4px;padding:6px;margin-bottom:10px;border:1px solid rgba(255,255,255,0.08)">
        ...
        <a href="https://www.hamropatro.com/" target="_blank" rel="noopener" class="hamropatro-btn">
            <i class="fa-regular fa-calendar-days"></i> View Full Calendar — Hamro Patro
        </a>
    </div>
</div>
...
{{-- SOCIAL --}}
<div class="widget">
    <div class="widget-head"><i class="fa-solid fa-users"></i> Follow Us</div>
    <div class="widget-body">
        <div class="social-btns">
            <a href="https://www.facebook.com/nepalnewsaustralia" target="_blank" rel="noopener" class="social-btn fb"><span><i class="fa-brands fa-facebook-f"></i> Facebook</span> <span>42,000 likes</span></a>
            <a href="https://www.youtube.com/@nepalnewsaustralia" target="_blank" rel="noopener" class="social-btn yt"><span><i class="fa-brands fa-youtube"></i> YouTube</span> <span>28,000 subs</span></a>
            <a href="https://twitter.com/nepalnewsaus" target="_blank" rel="noopener" class="social-btn tw"><span><i class="fa-brands fa-x-twitter"></i> Twitter</span> <span>15,000 followers</span></a>
            <a href="https://www.instagram.com/nepalnewsaustralia" target="_blank" rel="noopener" class="social-btn ig"><span><i class="fa-brands fa-instagram"></i> Instagram</span> <span>19,000 followers</span></a>
        </div>
    </div>
</div>
