    ...
    public function run(): void
    {
        ...
        $articles = [
            [
                ...
                'category'      => 'australia',
                'featured_image'=> 'https://static.vecteezy.com/system/resources/thumbnails/039/078/865/large/australia-and-nepal-flags-together-seamless-looping-background-looped-bump-texture-cloth-waving-slow-motion-3d-rendering-free-video.jpg',
                'is_featured'   => true,
                'is_breaking'   => true,
                'views'         => 4821,
                'status'        => 'published',
            ...
            [
                ...
                'category'      => 'nepal',
                'featured_image'=> 'https://picsum.photos/seed/nepal-economy/800/450',
                'is_featured'   => true,
                'is_breaking'   => false,
                'views'         => 3267,
                'status'        => 'published',
            ...
            [
                ...
                'category'      => 'australia',
                'featured_image'=> 'https://picsum.photos/seed/sydney-city/800/450',
                'is_featured'   => false,
                'is_breaking'   => false,
                'views'         => 2914,
                'status'        => 'published',
            ...
            [
                ...
                'category'      => 'community',
                'featured_image'=> 'https://picsum.photos/seed/melbourne-festival/800/450',
                'is_featured'   => true,
                'is_breaking'   => false,
                'views'         => 5102,
                'status'        => 'published',
            ...
            [
                ...
                'category'      => 'sports',
                'featured_image'=> 'https://assets-cdn.kathmandupost.com/uploads/source/news/2025/third-party/CANIMAGECELEBRATION-1760437478.jpg',
                'is_featured'   => false,
                'is_breaking'   => true,
                'views'         => 7638,
                'status'        => 'published',
            ...
            [
                ...
                'category'      => 'community',
                'featured_image'=> 'https://picsum.photos/seed/women-brisbane/800/450',
                'is_featured'   => false,
                'is_breaking'   => false,
                'views'         => 1893,
                'status'        => 'published',
            ...
            [
                ...
                'category'      => 'australia',
                'featured_image'=> 'https://picsum.photos/seed/australia-visa/800/450',
                'is_featured'   => false,
                'is_breaking'   => false,
                'views'         => 2341,
                'status'        => 'published',
            ...
            [
                ...
                'category'      => 'culture',
                'featured_image'=> 'https://picsum.photos/seed/patan-durbar/800/450',
                'is_featured'   => false,
                'is_breaking'   => false,
                'views'         => 1654,
                'status'        => 'published',
            ...
            [
                ...
                'category'      => 'opinion',
                'featured_image'=> 'https://picsum.photos/seed/nepal-politics/800/450',
                'is_featured'   => false,
                'is_breaking'   => false,
                'views'         => 987,
                'status'        => 'published',
            ...
            [
                ...
                'category'      => 'australia',
                'featured_image'=> 'https://picsum.photos/seed/student-visa/800/450',
                'is_featured'   => false,
                'is_breaking'   => false,
                'views'         => 1432,
                'status'        => 'published',
